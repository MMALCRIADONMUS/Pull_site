...
interface BlurTextProps {
    ...
    easing?: (t: number) => number; // Accepting a function looking like Easing
...
const BlurText = ({
    ...
    return (
        <Component ref={ref} className={className} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', width: '100%' }}>
